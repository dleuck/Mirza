...
public struct Palette: Codable, CustomStringConvertible, Identifiable, Hashable, Equatable {
    ...
    public static let social = Palette(
        name: "social", webRGB(12, 198, 171), webRGB(97, 60, 244), webRGB(190, 157, 0),
            webRGB(214, 101, 4)
    )
    
    public static let indri = Palette(
        name: "social", webRGB(12, 198, 171), webRGB(105, 83, 213), webRGB(190, 157, 0),
            webRGB(214, 101, 4)
    )
